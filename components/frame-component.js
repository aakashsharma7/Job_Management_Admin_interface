...
const FrameComponent = ({ className = "" }) => {
  return (
    ...
    >
      <div className="absolute top-[calc(50%_-_164px)] left-[calc(50%_-_142px)] rounded-[13.18px] [background:linear-gradient(180deg,_#fefefd,_#f1f1f1)] w-[83.5px] h-[82px] overflow-hidden">
        <div className="absolute top-[8.1px] left-[8.8px] rounded-83xl-5 bg-white w-[65.9px] h-[65.9px] overflow-hidden">
          <img
            className="absolute top-[calc(50%_-_19.05px)] left-[calc(50%_-_22.75px)] w-[45.1px] h-[45.1px] object-cover"
            alt=""
            src="/image-79@2x.png"
          />
        </div>
      </div>
      <b className="absolute top-[117px] left-[16px] text-xl">
        Node Js Developer
      </b>
